    ...
    public class ProductDAL : _BaseDAL, IProductDAL
    {
        ...
        {
            {
                ...
                {
                    SqlCommand cmd = new SqlCommand();
                    cmd.CommandText = @"INSERT INTO ProductAttribute(ProductID, AttributeName, AttributeValue, DisplayOrder)
        ...
        public long AddPhoto(ProductPhoto data)
        {

            {
                ...
                {
                    SqlCommand cmd = new SqlCommand();
                    cmd.CommandText = @"INSERT INTO ProductAttribute(ProductID, Photo, Description, DisplayOrder,IsHidden)
        ...
        public bool Delete(int productID)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand();
                cmd.CommandText = @"DELETE FROM Products WHERE ProductID = @ProductID AND NOT EXISTS(SELECT * FROM Products WHERE ProductID = @ProductID)";
                cmd.CommandType = CommandType.Text;
                cmd.Connection = cn;
        ...
        public bool DeleteAttribute(long attributeID)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand();
                cmd.CommandText = @"DELETE FROM ProductAttibutes WHERE AttributeID = @AttributeID AND NOT EXISTS(SELECT * FROM ProductAttribute WHERE AttributeID = @AttributeID)";
                cmd.CommandType = CommandType.Text;
                cmd.Connection = cn;
        ...
        public bool DeletePhoto(long photoID)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand();
                cmd.CommandText = @"DELETE FROM ProductPhotos WHERE PhotosID = @PhotosID AND NOT EXISTS(SELECT * FROM ProductPhotos WHERE PhotosID = @PhotosID)";
                cmd.CommandType = CommandType.Text;
                cmd.Connection = cn;
                cmd.Parameters.AddWithValue("@PhotosID", photoID);
            ...
            using (SqlConnection cn = OpenConnection())
            {
                ...
                if (dbReader.Read())
                {
                    data = new Product()
                    {
                        ...
                        CategoryID = Convert.ToInt32(dbReader["Category"]),
        ...
        {
            {
                ...
                {
                    SqlCommand cmd = new SqlCommand();
                    cmd.CommandText = @"SELECT CASE WHEN EXISTS(SELECT * FROM ProductAttribute WHERE ProductID = @ProductID) THEN 1 ELSE 0 END";
                    cmd.CommandText = @"SELECT CASE WHEN EXISTS(SELECT * FROM ProductPhoto WHERE ProductID = @ProductID) THEN 1 ELSE 0 END";
                    cmd.CommandType = CommandType.Text;
                    cmd.Connection = cn;
                    cmd.Parameters.AddWithValue("@ProductID", productID);
        ...
        public IList<ProductAttribute> ListAttributes(int productID)
        {
            ...
            using (SqlConnection cn = OpenConnection())
            {
                ...
                cmd.CommandText = @"SELECT *
                                    FROM ProductAttributes WHERE ProductID = @ProductID ORDER BY DisplayOrder ASC";
                cmd.CommandType = CommandType.Text;
                cmd.Connection = cn;
                cmd.Parameters.AddWithValue("@ProductID", productID);
        ...
        public IList<ProductPhoto> ListPhotos(int productID)
        {
            ...
            using (SqlConnection cn = OpenConnection())
            {
                SqlCommand cmd = cn.CreateCommand();
                cmd.CommandText = @"SELECT *
                                    FROM ProductPhoto WHERE ProductID = @ProductID ORDER BY DisplayOrder ASC";
                cmd.CommandType = CommandType.Text;
                cmd.Connection = cn;
                cmd.Parameters.AddWithValue("@ProductID", productID);
