...
namespace _20T1080068.Datalayers.SQLServer
{
    ...
    /// 
    /// </summary>
    public class CustomerDAL : _BaseDAL, ICommonDAL<Custommer>
    {
        /// <summary>
        /// Ctor
        /// </summary>
        ...
        public int Add(Custommer data)
        {
            ...
            using (SqlConnection cn = OpenConnection())
            {
                ...
                cmd.Connection = cn;
                cmd.Parameters.AddWithValue("@CustomerID", data.CustommerID);
                cmd.Parameters.AddWithValue("@CustomerName", data.CustommerName);
        ...
        public bool Delete(Custommer data)
        {
            throw new NotImplementedException();
        }
        ...
        public Custommer Get(int id)
        {
            ...
            using (SqlConnection cn = OpenConnection())
            {
                ...
                if (dbReader.Read())
                {
                    data = new Custommer()
                    {
                        CustommerID = Convert.ToInt32(dbReader["CustomerID"]),
                        CustommerName = Convert.ToString(dbReader["CustomerName"]),
        ...
        public bool InUsed(Custommer id)
        {
            throw new NotImplementedException();
        }
        ...
        /// <param name="searchValue"></param>
        /// <returns></returns>
        public IList<Custommer> List(int page, int pageSize, string searchValue)
        {
            List<Custommer> data = new List<Custommer>();
            ...
            using (SqlConnection cn = OpenConnection())
            {
                ...
                while (dbReader.Read())
                {
                    data.Add(new Custommer()
                    {
                        ///Convert.ToInt32(dbReader["CustomerID"]),
                        CustommerID = Convert.ToInt32(dbReader["CustomerID"]),
                        CustommerName = Convert.ToString(dbReader["CustomerName"]),
                        ContactName = Convert.ToString(dbReader["ContactName"]),
                        Address = Convert.ToString(dbReader["Address"]),
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        public bool Update(Custommer data)
        {
            bool result = false;
            using (SqlConnection cn = OpenConnection())
            {
