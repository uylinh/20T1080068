  ...
  /// </summary>
    public class OrderDataService
    {
        ...
        static OrderDataService()
        {
            ...
            orderDB = new Datalayers.OrderDAL(connectionString);
        }
        /// <summary>
        /// 
        /// </summary>
        ...
        /// <returns></returns>
        public static List<Order> ListOfOrders(int page, int pageSize, int status, string searchValue, out int rowCount)
        {
